...
export const metadata: Metadata = {
  ...
  description: "How Eline users can delete their account and app data.",
    ...
    <main className="min-h-screen bg-[#FDF8F5] px-5 py-10 text-eline-text sm:px-8 lg:px-12">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-8 rounded-[2rem] bg-white p-6 shadow-[0_20px_70px_rgba(23,32,42,0.08)] sm:p-10">
          <p className="text-sm font-black uppercase tracking-[0.16em] text-eline-coral">Account deletion</p>
          <h1 className="mt-4 text-[clamp(2.5rem,7vw,5.5rem)] font-black leading-[0.9] tracking-[-0.08em]">Delete your Eline account</h1>
          <p className="mt-6 text-base font-semibold leading-8 text-eline-muted">
            Eline includes an in-app account deletion flow. Deleting an account removes account access and starts removal of user data connected to the account according to Eline retention and safety requirements.
          </p>
        </section>
        ...
        <section className="mt-6 grid gap-4">
          <article className="rounded-[1.5rem] bg-white p-6 shadow-[0_14px_50px_rgba(23,32,42,0.06)]">
            ...
            <ol className="mt-4 list-decimal space-y-3 pl-5 text-sm font-semibold leading-7 text-eline-muted">
              <li>Open the Eline mobile app.</li>
          ...
          <article className="rounded-[1.5rem] bg-white p-6 shadow-[0_14px_50px_rgba(23,32,42,0.06)]">
            ...
            <p className="mt-4 text-sm font-semibold leading-7 text-eline-muted">
              If you cannot access the app, contact the Eline team through the support channel used to distribute the app and include the email address connected to the account you want deleted.
            </p>
            <Link href="/privacy" className="mt-4 inline-flex rounded-full bg-eline-coral px-5 py-3 text-sm font-black text-white">View privacy policy</Link>
          </article>
        </section>
      </div>
    </main>
